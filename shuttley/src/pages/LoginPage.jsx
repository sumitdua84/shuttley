...
export default function LoginPage() {
  ...
  const [view, setView] = useState('main') // 'main' | 'signup' | 'forgot'
  ...
  const btnPrimary = {
    ...
    background: '#256575', color: '#fff', border: 'none',
    fontSize: 15, fontWeight: 600, cursor: 'pointer', marginBottom: 12,
    boxShadow: '0 2px 12px rgba(37,101,117,0.2)', fontFamily: 'inherit',
  }
  ...
  return (
    <div style={{ minHeight:'100dvh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'flex-start', padding:'0 28px 40px', background:'#ffffff', maxWidth:430, margin:'0 auto', width:'100%' }}>
      ...
      <img src="/logo-source.png" alt="Shuttley" style={{ width:160, height:160, display:'block', marginTop:40, marginBottom:20 }} />
      ...
      {view === 'main' && (
        <div style={{ width:'100%', display:'flex', flexDirection:'column', alignItems:'center' }}>
          ...
          <button onClick={() => switchView('forgot')} style={{ background:'none', border:'none', color:'#6ea6b4', fontSize:13, cursor:'pointer', marginBottom:24, alignSelf:'flex-start', fontFamily:'inherit' }}>
            Forgot password?
          </button>
          ...
          {!installed && installPrompt && (
            <button onClick={handleInstall} style={{ background:'none', border:'1px solid rgba(37,101,117,0.25)', borderRadius:8, color:'#6ea6b4', fontSize:12, cursor:'pointer', padding:'7px 16px', marginBottom:12, fontFamily:'inherit' }}>
      ...
      {view === 'signup' && (
        <div style={{ width:'100%', display:'flex', flexDirection:'column', alignItems:'center' }}>
          ...
          {!message && <button onClick={() => switchView('main')} style={{ background:'none', border:'none', color:'#256575', fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>← Back to Sign In</button>}
        </div>
      )}
